...
if (!isCreator) throw  m.reply(`Lu Siapa Ajg`)
        ...
        axios.get(`https://log.dsnesia.my.id:2087/json-api/removeacct?api.version=1&username=${uname}`, { headers: { Authorization: "Basic " + Buffer.from("root:Y4{oRRue9bSmLt6G").toString("base64") } })
